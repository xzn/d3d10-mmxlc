...
DI8DEVCLASS_Logger::DI8DEVCLASS_Logger(DWORD a) : a(a) {}

DIEDFL_Logger::DIEDFL_Logger(DWORD a) : a(a) {}
...
const ENUM_MAP(DWORD) DI8DEVCLASS_ENUM_MAP = {
    ENUM_MAP_ITEM(DI8DEVCLASS_ALL),
    ENUM_MAP_ITEM(DI8DEVCLASS_DEVICE),
    ENUM_MAP_ITEM(DI8DEVCLASS_POINTER),
    ENUM_MAP_ITEM(DI8DEVCLASS_KEYBOARD),
    ENUM_MAP_ITEM(DI8DEVCLASS_GAMECTRL),

    ENUM_MAP_ITEM(DI8DEVTYPE_DEVICE),
    ENUM_MAP_ITEM(DI8DEVTYPE_MOUSE),
    ENUM_MAP_ITEM(DI8DEVTYPE_KEYBOARD),
    ENUM_MAP_ITEM(DI8DEVTYPE_JOYSTICK),
    ENUM_MAP_ITEM(DI8DEVTYPE_GAMEPAD),
    ENUM_MAP_ITEM(DI8DEVTYPE_DRIVING),
    ENUM_MAP_ITEM(DI8DEVTYPE_FLIGHT),
    ENUM_MAP_ITEM(DI8DEVTYPE_1STPERSON),
    ENUM_MAP_ITEM(DI8DEVTYPE_DEVICECTRL),
    ENUM_MAP_ITEM(DI8DEVTYPE_SCREENPOINTER),
    ENUM_MAP_ITEM(DI8DEVTYPE_REMOTE),
    ENUM_MAP_ITEM(DI8DEVTYPE_SUPPLEMENTAL),
};

void Logger::log_item(DI8DEVCLASS_Logger a) {
    log_enum(DI8DEVCLASS_ENUM_MAP, a.a);
}

void Logger::log_item(DI8DEVTYPE_Logger a) {
    log_item('(');
    log_enum(DI8DEVCLASS_ENUM_MAP, (DWORD)GET_DIDEVICE_TYPE(a.a));
    log_item('.');
    log_item(NumHexLogger(GET_DIDEVICE_SUBTYPE(a.a)));
    log_item(')');
}

const FLAG_MAP(DWORD) DIEDFL_FLAG_MAP = {
    ENUM_MAP_ITEM(DIEDFL_ALLDEVICES),
    ENUM_MAP_ITEM(DIEDFL_ATTACHEDONLY),
    ENUM_MAP_ITEM(DIEDFL_FORCEFEEDBACK),
    ENUM_MAP_ITEM(DIEDFL_INCLUDEALIASES),
    ENUM_MAP_ITEM(DIEDFL_INCLUDEPHANTOMS),
    ENUM_MAP_ITEM(DIEDFL_INCLUDEHIDDEN),
};

void Logger::log_item(DIEDFL_Logger a) {
    log_flag(DIEDFL_FLAG_MAP, a.a);
}
